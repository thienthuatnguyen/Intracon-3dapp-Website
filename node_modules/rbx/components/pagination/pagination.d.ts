...
export declare type PaginationVariables = Prefer<PaginationVariablesOverrides, PaginationVariablesDefaults>;
export declare type PaginationModifiers = Partial<{
    align: PaginationVariables["alignments"];
    rounded: boolean;
    size: PaginationVariables["sizes"];
}>;
export declare type PaginationProps = HelpersProps & PaginationModifiers;
export declare const Pagination: Pick<React.ForwardRefExoticComponent<React.ReactType<any>>, "displayName" | "$$typeof"> & {
    ...
    Ellipsis: import("../../base/exotic").ForwardRefAsExoticComponent<Prefer<import("../../base/helpers").HelpersPropsOverrides, Partial<{
        clearfix: boolean;
        pull: "left" | "right";
    }> & Partial<{
        clipped: boolean;
    ...
    Link: import("../../base/exotic").ForwardRefAsExoticComponent<import("./pagination-link").PaginationLinkProps, React.ReactType<any>>;
    List: import("../../base/exotic").ForwardRefAsExoticComponent<Prefer<import("../../base/helpers").HelpersPropsOverrides, Partial<{
        clearfix: boolean;
        pull: "left" | "right";
    }> & Partial<{
        clipped: boolean;
    ...
    Step: import("../../base/exotic").ForwardRefAsExoticComponent<import("./pagination-step").PaginationStepProps, React.ReactType<any>>;
};
