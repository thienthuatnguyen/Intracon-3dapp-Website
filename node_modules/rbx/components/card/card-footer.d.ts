...
export declare type CardFooterProps = HelpersProps;
export declare const CardFooter: Pick<React.ForwardRefExoticComponent<React.ReactType<any>>, "displayName" | "$$typeof"> & {
