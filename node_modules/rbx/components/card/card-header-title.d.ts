...
export declare type CardHeaderTitleModifierProps = Partial<{
...
export declare const CardHeaderTitle: import("../../base/exotic").ForwardRefAsExoticComponent<CardHeaderTitleProps, React.ReactType<any>>;
