...
export declare type PanelTabModifierProps = Partial<{
    active: boolean;
}>;
export declare type PanelTabProps = HelpersProps & PanelTabModifierProps;
export declare const PanelTab: Pick<React.ForwardRefExoticComponent<React.ReactType<any>>, "displayName" | "$$typeof"> & {
