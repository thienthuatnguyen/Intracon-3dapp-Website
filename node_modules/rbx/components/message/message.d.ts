...
export declare const MESSAGE_DEFAULTS: {
...
export declare type MessageVariables = Prefer<MessageVariablesOverrides, MessageVariablesDefaults>;
export declare type MessageModifierProps = Partial<{
    color: Variables["colors"];
    size: MessageVariables["sizes"];
}>;
export declare type MessageProps = HelpersProps & MessageModifierProps;
export declare const Message: Pick<React.ForwardRefExoticComponent<React.ReactType<any>>, "displayName" | "$$typeof"> & {
    ...
    Header: import("../../base/exotic").ForwardRefAsExoticComponent<Prefer<import("../../base/helpers").HelpersPropsOverrides, Partial<{
        clearfix: boolean;
        pull: "left" | "right";
    }> & Partial<{
        clipped: boolean;
