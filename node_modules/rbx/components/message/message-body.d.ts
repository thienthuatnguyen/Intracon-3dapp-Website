...
export declare type MessageBodyProps = HelpersProps;
export declare const MessageBody: import("../../base/exotic").ForwardRefAsExoticComponent<import("../../types").Prefer<import("../../base/helpers").HelpersPropsOverrides, Partial<{
    clearfix: boolean;
    pull: "left" | "right";
}> & Partial<{
    clipped: boolean;
