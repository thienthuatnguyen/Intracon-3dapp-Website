...
export declare type NavbarDropdownModifierProps = Partial<{
    align: NavbarDropdownVariables["alignments"];
    boxed: boolean;
}>;
export declare type NavbarDropdownProps = HelpersProps & NavbarDropdownModifierProps;
export declare const NavbarDropdown: import("../../base/exotic").ForwardRefAsExoticComponent<NavbarDropdownProps, React.ReactType<any>>;
