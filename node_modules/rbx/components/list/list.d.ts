...
export declare type ListProps = HelpersProps;
export declare const List: Pick<React.ForwardRefExoticComponent<React.ReactType<any>>, "displayName" | "$$typeof"> & {
    ...
    Item: import("../../base/exotic").ForwardRefAsExoticComponent<import("./list-item").ListItemProps, React.ReactType<any>>;
};
