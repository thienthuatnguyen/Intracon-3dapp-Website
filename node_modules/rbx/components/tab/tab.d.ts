...
export declare type TabModifierProps = Partial<{
    active: boolean;
}>;
export declare type TabProps = HelpersProps & TabModifierProps;
export declare const Tab: Pick<React.ForwardRefExoticComponent<React.ReactType<any>>, "displayName" | "$$typeof"> & {
    ...
    Group: import("../../base/exotic").ForwardRefAsExoticComponent<import("./tab-group").TabGroupProps, React.ReactType<any>>;
};
