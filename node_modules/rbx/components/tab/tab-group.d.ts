...
export declare type TabGroupModifierProps = Partial<{
...
export declare const TabGroup: import("../../base/exotic").ForwardRefAsExoticComponent<TabGroupProps, React.ReactType<any>>;
