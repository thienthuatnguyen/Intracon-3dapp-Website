...
export declare type LevelModifierProps = Partial<{
    breakpoint: Variables["breakpoints"];
}>;
export declare type LevelProps = HelpersProps & LevelModifierProps;
export declare const Level: Pick<React.ForwardRefExoticComponent<React.ReactType<any>>, "displayName" | "$$typeof"> & {
    ...
    Item: import("../../base/exotic").ForwardRefAsExoticComponent<import("./level-item").LevelItemProps, React.ReactType<any>>;
};
