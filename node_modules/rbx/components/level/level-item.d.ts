...
export declare type LevelItemModifierProps = Partial<{
    align: LevelItemVariables["alignments"];
}>;
export declare type LevelItemProps = HelpersProps & LevelItemModifierProps;
export declare const LevelItem: import("../../base/exotic").ForwardRefAsExoticComponent<LevelItemProps, React.ReactType<any>>;
