...
export declare const BREADCRUMB_DEFAULTS: {
...
export declare type BreadcrumbVariables = Prefer<BreadcrumbVariablesOverrides, BreadcrumbVariablesDefaults>;
export declare type BreadcrumbModifierProps = Partial<{
    align: BreadcrumbVariables["alignments"];
    separator: BreadcrumbVariables["separators"];
    size: BreadcrumbVariables["sizes"];
}>;
export declare type BreadcrumbProps = HelpersProps & BreadcrumbModifierProps;
export declare const Breadcrumb: Pick<React.ForwardRefExoticComponent<React.ReactType<any>>, "displayName" | "$$typeof"> & {
    ...
    Item: import("../../base/exotic").ForwardRefAsExoticComponent<import("./breadcrumb-item").BreadcrumbItemProps, React.ReactType<any>>;
};
