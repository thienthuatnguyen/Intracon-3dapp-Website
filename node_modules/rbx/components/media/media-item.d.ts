...
export declare type MediaItemModifierProps = Partial<{
    align: MediaItemVariables["alignments"];
}>;
export declare type MediaItemProps = HelpersProps & MediaItemModifierProps;
export declare const MediaItem: import("../../base/exotic").ForwardRefAsExoticComponent<MediaItemProps, React.ReactType<any>>;
