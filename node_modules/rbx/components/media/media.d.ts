...
export declare type MediaProps = HelpersProps;
export declare const Media: Pick<React.ForwardRefExoticComponent<React.ReactType<any>>, "displayName" | "$$typeof"> & {
    ...
    Item: import("../../base/exotic").ForwardRefAsExoticComponent<import("./media-item").MediaItemProps, React.ReactType<any>>;
};
