(function (global, factory) {
    ...
    ***************************************************************************** */
    ...
    const DEFAULTS = {
        colors: tuple("primary", "success", "info", "warning", "danger", "light", "dark", "white", "black", "link"),
        shades: tuple("black-bis", "black-ter", "grey-darker", "grey-dark", "grey", "grey-light", "grey-lighter", "white-ter", "white-bis"),
        floatPulledAlignments: tuple("left", "right"),
        breakpoints: tuple("mobile", "tablet", "desktop", "widescreen", "fullhd", "touch"),
    ...
    const makeRootValidatingTransformFactory = (...makeValidatingTransformFuncs) => (variables = DEFAULTS) => {
    ...
    const transform = props => {
        const { clearfix, pull } = props, rest = __rest(props, ["clearfix", "pull"]);
    ...
    const transform$1 = props => {
        const { marginless, paddingless, radiusless, shadowless, unselectable } = props, rest = __rest(props, ["marginless", "paddingless", "radiusless", "shadowless", "unselectable"]);
        rest.className = classNames({
    ...
    const transform$2 = props => {
        const { clipped } = props, rest = __rest(props, ["clipped"]);
    ...
    const transform$3 = props => {
        const { overlay } = props, rest = __rest(props, ["overlay"]);
    ...
    const transform$4 = props => {
        const { responsive } = props, rest = __rest(props, ["responsive"]);
        rest.className = classNames(responsive !== undefined
    ...
    const transform$5 = props => {
        const { backgroundColor, italic, textAlign, textColor, textSize, textTransform, textWeight } = props, rest = __rest(props, ["backgroundColor", "italic", "textAlign", "textColor", "textSize", "textTransform", "textWeight"]);
        rest.className = classNames({
    ...
    const transform$6 = props => {
        const { hidden, invisible, srOnly } = props, rest = __rest(props, ["hidden", "invisible", "srOnly"]);
        rest.className = classNames({
            "is-hidden": hidden,
    ...
    const makeRootValidatingTransform = makeRootValidatingTransformFactory(makeValidatingTransform, makeValidatingTransform$2, makeValidatingTransform$3, makeValidatingTransform$5, makeValidatingTransform$6, makeValidatingTransform$1, makeValidatingTransform$4);
