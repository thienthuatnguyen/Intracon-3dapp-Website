...
export declare type SectionModifierProps = Partial<{
    size: SectionVariables["sizes"];
}>;
export declare type SectionProps = HelpersProps & SectionModifierProps;
export declare const Section: import("../../base/exotic").ForwardRefAsExoticComponent<SectionProps, React.ReactType<any>>;
