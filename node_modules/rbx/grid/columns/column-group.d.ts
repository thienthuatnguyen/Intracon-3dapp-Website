...
export declare type ColumnGroupBreakpointOptions = Partial<{
    gapSize: ColumnGroupVariables["gapSizes"];
}>;
declare type ColumnGroupModifierProps = Partial<{
...
export declare const ColumnGroup: import("../../base/exotic").ForwardRefAsExoticComponent<ColumnGroupProps, React.ReactType<any>>;
export {};
