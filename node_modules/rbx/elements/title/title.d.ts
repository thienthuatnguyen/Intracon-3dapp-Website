...
export declare type TitleModifierProps = Partial<{
    size: TitleVariables["sizes"];
    spaced: boolean;
    subtitle: boolean;
}>;
export declare type TitleProps = HelpersProps & TitleModifierProps;
export declare const Title: import("../../base/exotic").ForwardRefAsExoticComponent<TitleProps, React.ReactType<any>>;
