...
export declare type ProgressModifierProps = Partial<{
...
export declare const Progress: import("../../base/exotic").ForwardRefAsExoticComponent<ProgressProps, React.ReactType<any>>;
