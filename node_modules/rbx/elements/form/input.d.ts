...
export declare type InputModifierProps = Partial<{
...
export declare const Input: import("../../base/exotic").ForwardRefAsExoticComponent<InputProps, React.ReactType<any>>;
