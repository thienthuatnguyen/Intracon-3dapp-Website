...
export declare type LabelModifierProps = Partial<{
    disabled: boolean;
    size: LabelVariables["sizes"];
}>;
export declare type LabelProps = HelpersProps & LabelModifierProps;
export declare const Label: import("../../base/exotic").ForwardRefAsExoticComponent<LabelProps, React.ReactType<any>>;
