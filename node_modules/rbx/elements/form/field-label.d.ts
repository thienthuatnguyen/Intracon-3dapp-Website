...
export declare type FieldLabelModifierProps = Partial<{
    size: FieldLabelVariables["sizes"];
}>;
export declare type FieldLabelProps = HelpersProps & FieldLabelModifierProps;
export declare const FieldLabel: import("../../base/exotic").ForwardRefAsExoticComponent<FieldLabelProps, React.ReactType<any>>;
