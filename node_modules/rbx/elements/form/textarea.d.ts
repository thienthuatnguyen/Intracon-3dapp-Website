...
export declare type TextareaModifierProps = Partial<{
...
export declare const Textarea: import("../../base/exotic").ForwardRefAsExoticComponent<TextareaProps, React.ReactType<any>>;
