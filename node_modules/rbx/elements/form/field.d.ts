...
export declare type FieldModifierProps = Partial<{
...
export declare const Field: Pick<React.ForwardRefExoticComponent<React.ReactType<any>>, "displayName" | "$$typeof"> & {
    ...
    Label: import("../../base/exotic").ForwardRefAsExoticComponent<import("./field-label").FieldLabelProps, React.ReactType<any>>;
};
