...
export declare type CheckboxProps = HelpersProps;
export declare const Checkbox: import("../../base/exotic").ForwardRefAsExoticComponent<import("../../types").Prefer<import("../../base/helpers").HelpersPropsOverrides, Partial<{
    clearfix: boolean;
    pull: "left" | "right";
}> & Partial<{
    clipped: boolean;
