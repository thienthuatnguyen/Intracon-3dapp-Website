...
export declare type ControlModifierProps = Partial<{
    expanded: boolean;
    iconLeft: boolean;
    iconRight: boolean;
    loading: boolean;
...
export declare const Control: import("../../base/exotic").ForwardRefAsExoticComponent<ControlProps, React.ReactType<any>>;
