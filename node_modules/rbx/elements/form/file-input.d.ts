...
export declare type FileInputProps = HelpersProps;
export declare const FileInput: import("../../base/exotic").ForwardRefAsExoticComponent<import("../../types").Prefer<import("../../base/helpers").HelpersPropsOverrides, Partial<{
    clearfix: boolean;
    pull: "left" | "right";
}> & Partial<{
    clipped: boolean;
