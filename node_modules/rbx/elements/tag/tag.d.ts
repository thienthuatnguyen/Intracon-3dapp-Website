...
export declare type TagModifierProps = Partial<{
...
export declare const Tag: Pick<React.ForwardRefExoticComponent<React.ReactType<any>>, "displayName" | "$$typeof"> & {
    ...
    Group: import("../../base/exotic").ForwardRefAsExoticComponent<import("./tag-group").TagGroupProps, React.ReactType<any>>;
};
