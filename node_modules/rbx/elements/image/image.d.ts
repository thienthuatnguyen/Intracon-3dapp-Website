...
export declare type ImageModifierProps = Partial<{
    rounded: boolean;
}>;
export declare type ImageProps = HelpersProps & ImageModifierProps;
export declare const Image: Pick<React.ForwardRefExoticComponent<React.ReactType<any>>, "displayName" | "$$typeof"> & {
    ...
    Container: import("../../base/exotic").ForwardRefAsExoticComponent<import("./image-container").ImageContainerProps, React.ReactType<any>>;
};
