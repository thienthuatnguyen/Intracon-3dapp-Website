...
export declare type ImageContainerModifierProps = Partial<{
    size: ImageContainerVariables["sizes"];
}>;
export declare type ImageContainerProps = HelpersProps & ImageContainerModifierProps;
export declare const ImageContainer: import("../../base/exotic").ForwardRefAsExoticComponent<ImageContainerProps, React.ReactType<any>>;
