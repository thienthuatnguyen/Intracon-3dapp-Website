...
export declare const CONTENT_ORDERED_LIST_DEFAULTS: {
...
export declare type ContentOrderedListVariables = Prefer<ContentOrderedListVariablesOverrides, ContentOrderedListVariablesDefaults>;
export declare type ContentOrderedListModifierProps = Partial<{
    type: ContentOrderedListVariables["types"];
}>;
export declare type ContentOrderedListProps = HelpersProps & ContentOrderedListModifierProps;
export declare const ContentOrderedList: Pick<React.ForwardRefExoticComponent<React.ReactType<any>>, "displayName" | "$$typeof"> & {
