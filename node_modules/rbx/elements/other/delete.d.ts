...
export declare type DeleteModifierProps = Partial<{
    size: DeleteVariables["sizes"];
}>;
export declare type DeleteProps = HelpersProps & DeleteModifierProps;
export declare const Delete: import("../../base/exotic").ForwardRefAsExoticComponent<DeleteProps, React.ReactType<any>>;
