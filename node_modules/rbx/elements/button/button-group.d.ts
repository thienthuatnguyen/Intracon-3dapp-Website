...
export declare type ButtonGroupModifierProps = Partial<{
...
export declare const ButtonGroup: import("../../base/exotic").ForwardRefAsExoticComponent<ButtonGroupProps, React.ReactType<any>>;
