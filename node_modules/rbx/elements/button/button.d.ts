...
export declare type ButtonVariables = Prefer<ButtonVariablesOverrides, ButtonVariablesDefaults>;
export declare type ButtonModifierProps = Partial<{
...
export declare type ButtonProps = HelpersProps & ButtonModifierProps;
export declare const Button: Pick<React.ForwardRefExoticComponent<React.ReactType<any>>, "displayName" | "$$typeof"> & {
    ...
    Group: import("../../base/exotic").ForwardRefAsExoticComponent<import("./button-group").ButtonGroupProps, React.ReactType<any>>;
};
