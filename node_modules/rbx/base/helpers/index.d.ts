...
export declare type HelpersProps = Prefer<HelpersPropsOverrides, FloatHelpersProps & OverflowHelpersProps & OverlayHelpersProps & TypographyHelpersProps & VisibilityHelpersProps & OtherHelpersProps & ResponsiveHelpersProps & {
    className?: string;
}>;
export declare const makeRootValidatingTransform: import("./factory").MakeValidatingTransformFunction<Prefer<HelpersPropsOverrides, Partial<{
    clearfix: boolean;
    pull: "left" | "right";
}> & Partial<{
    clipped: boolean;
