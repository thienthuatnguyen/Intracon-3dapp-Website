...
class Server {
    ...
    async render(req, res, pathname, query = {}, parsedUrl) {
        ...
        if (this.nextConfig.poweredByHeader) {
            res.setHeader('X-Powered-By', 'Next.js ' + "8.0.4-canary.1");
        }
        return this.sendHTML(req, res, html);
    }
    async renderToAMP(req, res, pathname, query = {}, parsedUrl) {
    ...
    async renderToAMPHTML(req, res, pathname, query = {}) {
        if (!this.nextConfig.experimental.amp) {
            throw new Error('"experimental.amp" is not enabled in "next.config.js"');
        }
        return this.renderToHTML(req, res, pathname, query, { amphtml: true });
    }
    async renderToHTML(req, res, pathname, query = {}, { amphtml } = {}) {
        try {
            // To make sure the try/catch is executed
            const html = await this.renderToHTMLWithComponents(req, res, pathname, query, Object.assign({}, this.renderOpts, { amphtml }));
            return html;
        }
        catch (err) {
            if (err.code === 'ENOENT') {
