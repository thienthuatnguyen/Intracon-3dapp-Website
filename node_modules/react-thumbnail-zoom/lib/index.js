...
var _viewportSize = require("viewport-size");

var _viewportSize2 = _interopRequireDefault(_viewportSize);
...
var ImageZoom = (_temp = _class = function (_React$Component) {
  ...
  ImageZoom.prototype.render = function render() {
    ...
    var original = _react2.default.cloneElement(child, {
      ref: function ref(image) {
        return _this2.thumb = image;
      },
      onClick: this.onClickThumbnail,
      className: (0, _classnames2.default)(child.className, this.state.loading && "image-zoom-loading"),
  ...
  this.determineTargetDimensions = function (image) {
    var iw = image.width;
    var ih = image.height;
    var vph = _viewportSize2.default.getHeight();
    var vpw = _viewportSize2.default.getWidth();
...
process.env.NODE_ENV !== "production" ? ImageZoom.propTypes = {
  zoomedIn: _propTypes2.default.bool,
  onZoomToggle: _propTypes2.default.func,
  zoomedInURL: _propTypes2.default.string,
