...
/***/ (function(module, exports, __webpack_require__) {
	...
	var DocxUI = __webpack_require__(645);

	window.createDocxJS = function(){
	    var docxjs = new DocxJS();
	    docxjs.setUI(new DocxUI());

	    return docxjs;
	};

	window.docxParser = function(file, successFn, errorFn){
	    window.docxJS.parse(file, successFn, errorFn);
	};

	window.docxAfterRender = function(element, callBackFn, sheetId) {
	    window.docxJS.render(element, callBackFn, sheetId);
	};
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var MobileUI = __webpack_require__(646);
	var DesktopUI = __webpack_require__(646);
...
/***/ (function(module, exports) {
	...
	DesktopUI.prototype = {
	    Config: {
	        ...
	        styles: {
	            header: {
	                wrapper: "z-index: 1000; display: none; width: 100%; height: 41px; position: relative; margin: 0; padding: 0; background: " + themeColor + "; font-family: Arial; transform: translate3d(0px, 0px, 0px); -webkit-transform: translate3d(0px, 0px, 0px); -ms-transform: translate3d(0px, 0px, 0px);",
	            ...
	            footer: {
	                wrapper: "z-index: 1000; display: none; position: absolute; width: 100%; height: 25px; background: " + themeColor + "; bottom: 0; margin: 0; padding: 0; font-family: Arial; ",
	            ...
	            modal: {
	                ...
	                body: 'padding: 50px; font-size:12px; height:400px; overflow:auto;word-break: break-word;'
	            }
	        }
	    },
	    ...
	    createTemplate: function () {
	        ...
	        this.$menuBtns = {
	            header: {
	                ...
	                fullscreen: $('' +
	                    '<li id="docFull" style="' + this.Config.styles.header.buttonGroupItem + '">' +
	                        '<a style="' + this.Config.styles.header.btnA + '">' +
	            ...
	            footer: {
	                ...
	                zoomOut: $('' +
	                    '<div id="docZoomOut" style="' + this.Config.styles.footer.floatButton + '">' +
	                        '<a style="' + this.Config.styles.header.btnA + '">' +
	                ...
	                zoomIn: $('' +
	                    '<div id="docZoomIn" style="' + this.Config.styles.footer.floatButton + '">' +
	                        '<a style="' + this.Config.styles.header.btnA + '">' +
	                            '<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 63 63" xml:space="preserve" style="' + this.Config.styles.footer.icon + '">' +
	                                '<g fill="#ffffff">' +
	        ...
	        var $fileName = $('<div style="max-width: 50%; font-size: 10px; padding: 5px; color: #ffffff;"><span> ' + this.fileInfo.fileName + ' </span></div>');
	        this.$pageInfo = $('<div style="' + this.Config.styles.header.rightMenu + 'font-size: 10px; padding: 5px; color: #ffffff;"></div>');
	    ...
	    extractText: function(){
	        ...
	        this.jsViewer.extractText(true, function(texts){
	            $modalBody.empty();
	            $modalBody.html(texts);
	            _this.$modal.show();
	        });
	    },
